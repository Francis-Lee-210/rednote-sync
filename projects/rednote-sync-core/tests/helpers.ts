...
export function withMergeCandidates<T extends { readonly manifests: readonly NoteManifest[] }>(mutation: T, mediaSetComplete = true): T & { readonly candidates: readonly import("../src/index.ts").ValidatedMergeCandidateInput[] } {
