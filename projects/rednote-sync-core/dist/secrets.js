...
function assertSafeString(value        , registry                      , key               )       {
...
export function assertPersistenceSafe(value         , registry                      , seen = new WeakSet        (), key                = null)       {
...
export function assertSerializedPersistenceSafe(bytes                     , registry                      )       {
  ...
  try { structured = JSON.parse(trimmed); }
    ...
    if (lines.length > 0 && lines.every((line) => line.startsWith("{") || line.startsWith("["))) {
      try { structured = lines.map((line) => JSON.parse(line)           ); } catch { structured = undefined; }
    }
  }
