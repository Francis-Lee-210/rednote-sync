...
function errorCategory(error         )                             {
  ...
  if (error !== null && typeof error === "object" && "category" in error) {
    ...
    if (typeof category === "string" && ["INVALID_INPUT", "AUTH_REQUIRED", "RATE_LIMITED", "NETWORK", "PROTOCOL", "DETAIL", "MEDIA", "EXPORT", "STATE", "DERIVED_VIEW", "PAUSED", "BUSY", "INTERNAL"].includes(category)) return category                 ;
  }
  return "INTERNAL";
}
